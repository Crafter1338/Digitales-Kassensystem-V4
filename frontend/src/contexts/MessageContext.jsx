...
function Message({ message, type, timeout }) {
    return (
        <Card sx={{ width: 0.65, maxWidth: 400 }} color={typeToColor[type]} variant="soft">
...
export function MessageProvider({ children }) {
    ...
    const write = (message, type = 'neutral', duration = 2500) => {
        ...
        const component = (
            <Message message={message} type={type} timeout={timeout} />
        );
